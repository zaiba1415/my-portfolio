    ...
    <div data-aos="fade-up" className="bg-[#121212] py-8 px-4  sm:py-16 xl:px-16  ">
      <div>
        ...
        <div data-aos="fade-up" className="flex justify-center items-center space-x-6">
         <Link href={"https://www.linkedin.com/in/zaiba-maqsood-8004212a6/"} ><TiSocialLinkedinCircular data-aos="fade-up"size={53} className="text-neutral-600 hover:text-purple-500
          transition-all duration-200 cursor-pointer"/></Link>
        <Link href={"https://github.com/zaiba1415"}><VscGithub data-aos="fade-up" size={40} className="text-neutral-600 hover:text-purple-500
