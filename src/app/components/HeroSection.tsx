  ...
  return (
    ...
    <div data-aos="fade-up" className='grid grid-cols-1 sm:grid-cols-12 h-screen  bg-[#121212]'>
      <div className='col-span-7 px-12  md:px-14 text-center sm:text-left'>
        ...
        bg-clip-text font-serif font-bold   md:mt-7 lg:mt-8 mt-4 '>Zaiba Maqsood</h1>
    ...
    />
        ...
        {' '} to building responsive websites that engage and inspire</p>
         ...
         <div> 
        <a data-aos="fade-up-right" href='https://github.com/zaiba1415' className='flex items-center justify-center mt-8 px-6 py-3 w-full sm:w-fit rounded-md mr-4 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-200 text-white hover:scale-105'>Github Profile </a>
