   ...
   <p className='text-xl md:text-4xl lg:text-5xl font-bold'>Zaibi</p>
        <div className='hidden md:block md:w-auto'>
            <ul className='space-x-8 flex text-[#ADB7BE] rounded font-semibold mx-6 p-4 md:p-0 md:flex-row md:space-x-8 mt-0 '>
                ...
                <Link href={'/'}><li className='hover:text-white '>About</li></Link>
                <Link href={'/'}><li className='hover:text-white'>Skills</li></Link>
                <Link href={'/'}><li className='hover:text-white'>Work</li></Link>
