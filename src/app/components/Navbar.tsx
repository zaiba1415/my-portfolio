...
const Navbar = () => {
  ...
  <nav className='sticky bg-[#121212] top-0 left-0 right-0 z-10 w-full px-4 xl:px-8  '>
   ...
   <p className='text-xl text-white md:text-4xl lg:text-5xl font-bold '>Zaiba</p>
        ...
        <div  className="lg:hidden md:hidden text-white sm:flex flex-col justify-end text-2xl">
            <button onClick={toggleNavbar} className="py-3">{openNav ? <RxCross2 /> :<HiMenuAlt3 />}</button>
        </div>
    </div>
    {
        openNav && (
            <div   className="sticky left-0 z-20 bg-[#0f0407] h-full  w-full p-4 flex flex-col justify-start items-start px-12  md:hidden">
